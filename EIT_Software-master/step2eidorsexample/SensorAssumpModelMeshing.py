...
DistMin = 14 # make this bigger as the wall is 2mm thick
...
PlaneP1=fields.addPoint(-extents,40,-extents,Lmin)
PlaneP2=fields.addPoint(-extents,40,extents,Lmin)
PlaneP3=fields.addPoint(extents,40,extents,Lmin)
PlaneP4=fields.addPoint(extents,40,-extents,Lmin)
...
model.mesh.optimize('',niter=20)
model.mesh.optimize('Netgen',niter=30)

...
% run the MakeSensorMeshesThinWalled.py to make the .vtu file
...
MDL=eidors_obj('fwd_model','BalloonSensorThinWalled');
...
% as an example, lets define a ring of electrodes at Z =0 as per Sainas
% example
...
meshio.write('thinwalled_currentmag.vtu',MDL.nodes,MDL.elems,{elemcur_mag(1:100)},{'currentmagnitude'});
...
meshio.write('thinwalled_J.vtu',MDL.nodes,MDL.elems,{Sens},{'J'});

...
class ardInterface:
    ...
    def __init__(self, ardName, numPort):
        ...
        self.press9 = 0.0
        self.press10 = 0.0
        #self.pressArray = np.array([self.press1, self.press2, 
        #                            self.press3, self.press4, 
        #                            self.press5, self.press6, 
        #                            self.press7, self.press8, 
        #                            self.press9, self.press10])
